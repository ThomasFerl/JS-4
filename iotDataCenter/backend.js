...
const port                  = '4040';
const MQTT_BROKER_URL       = 'mqtt://192.168.100.10:1883'; 
...
var mqttOptions = {
  ...
  // hier ggf. Benutzername / Passwort eintragen
  username       : 'mqttUser',
  password       : 'odPghgNix#1!' ,
  clientId       : 'iotDataCenter_' + Math.random().toString(16).substr(2, 8),
  clean          : true,
  connectTimeout : 4000,
